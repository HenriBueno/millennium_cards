...
export default function Bag() {
  ...
  return (
    ...
    >
      <DialogBackdrop className="fixed inset-0 bg-transparence bg-opacity-50 transition-opacity" />
        ...
        <DialogPanel className="w-screen max-w-md bg-white shadow-xl transform transition-all duration-500 ease-in-out translate-x-0">
          <div className="flex h-full flex-col overflow-y-auto">
            ...
            <div className="border-t p-4">
              ...
              <a
                href="#"
                className="mt-4 block bg-indigo-600 text-white text-center py-2 rounded-md hover:bg-indigo-700"
              >
                Checkout
              </a>
